...
_OBJ_TEST = main_old.cpp simpleGameEngine.cpp logger.cpp shader.cpp texture.cpp vertexArray.cpp vertexBuffer.cpp camera.cpp sprite.cpp resourceManager.cpp scene.cpp mesh.cpp 
