...
_OBJ = main.cpp simpleGameEngine.cpp logger.cpp shader.cpp texture.cpp renderer.cpp vertexArray.cpp vertexBuffer.cpp camera.cpp sprite.cpp resourceManager.cpp scene.cpp
