...
namespace Lynx {
		...
		void Editor::setupStyle()
		{
			...
			style.Colors[ImGuiCol_Header] 				 = ImVec4(1.00f, 1.00f, 1.00f, 0.94f);
			style.Colors[ImGuiCol_HeaderHovered]		 = ImVec4(0.26f, 0.59f, 0.98f, 0.40f);
			style.Colors[ImGuiCol_HeaderActive]			 = ImVec4(0.86f, 0.59f, 0.28f, 0.67f);
