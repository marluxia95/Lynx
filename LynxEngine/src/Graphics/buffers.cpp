...
namespace Lynx::Graphics {
	...
	VertexBuffer* VertexBuffer::Create(vector<Vertex>* vertices)
	{
		switch ( IRendererAPI::GetAPI() ) {
	...
	VertexBuffer* VertexBuffer::Create(vector<Vertex>* vertices, MeshType type)
	{
		switch ( IRendererAPI::GetAPI() ) {
    ...
    ElementBuffer* ElementBuffer::Create(vector<GLuint>* indices)
	{
		switch ( IRendererAPI::GetAPI() ) {
